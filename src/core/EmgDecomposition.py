    ...
    def post_process_across_arrays(self):
            ...
            if (i < len(self.mu_dict["pulse_trains"]) and 
                ...
                for j in range(motor_unit_count):
                    ...
                    if (mu < mu_count and 
                        ...
                        print(f"Warning: Skipping MU {j} in array {i} due to bounds check failure")
        ...
        for i in range(no_arrays):
            ...
            if len(idx) > 0 and all(j < len(pulse_trains_new) for j in idx):
                ...
                print(f"Warning: Created empty pulse_trains for array {i+1}")
            ...
            for j in range(motor_unit_count):
                if (j < len(idx) and 
                    ...
                    print(f"Warning: Added empty discharge_times for array {i+1}, MU {j}")
