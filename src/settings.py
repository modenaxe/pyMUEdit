...
At the time of writing, the ability to change settings has not been implemented. 

I've copied this file over from openhdemg since there are a couple functions that request for certain settings from here. While the ability to change settings haven't been implemented, I thought pulling settings from here was better than hardcoding values across the app. 

The following code is entirely from OPENHDEMG
"""
"""
