...
class Sidebar(QFrame):
    ...
    def __init__(self, app_title="HDEMG App", parent=None):
        ...
        app_title_label.setStyleSheet(f"background-color: {CleanTheme.BG_CARD}; color: {CleanTheme.TEXT_PRIMARY}")
        ...
        self.nav_container.setStyleSheet(f"background-color: {CleanTheme.BG_CARD}")
    ...
    def add_recent_files_section(self, recent_files, on_file_clicked=None):
        ...
        self.recent_files_section.setStyleSheet(f"background-color: {CleanTheme.BG_CARD}")
        ...
        recent_header.setStyleSheet(f"background-color: {CleanTheme.BG_CARD}; color: {CleanTheme.TEXT_PRIMARY}")
